...
import { createProduct,getProducts, getProductsForAdmin, listUnListProduct, singleProduct, updateProduct } from "../controllers/ProductCtrl.js";
...
productRoute.get("/admin", isLoggedIn, isAdmin, getProductsForAdmin);
