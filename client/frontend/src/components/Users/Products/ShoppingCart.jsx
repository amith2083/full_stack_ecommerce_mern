...
export default function ShoppingCart() {
  ...
  console.log(cartItems, loading, error);
  ...
  // },0)
  const sumOfTotalPrice = cartItems
  .map(cart => 
    cart.items.reduce((acc, item) => acc + item.totalPrice, 0) // Sum up `totalPrice` for each `items` array
  )
